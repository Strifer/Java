...
/**
 * This class defines a basic subtraction operation in our application.
 */
public class Subtraction implements IMathOperation {
     ...
     */
    public Subtraction(Context ctxt) {
        this.ctxt=ctxt;
    }
    ...
    public String getName() {
        return this.ctxt.getResources().getString(R.string.subtract);
    }
}
