...
/**
 * <code>ArrayBackedIndexCollection</code> represents a dynamic array of objects.
 * An object of type <code>ArrayBackedIndexCollection</code> contains three
 * fields representing its size, capacity and all of the elements it contains.
 * <p>
 ...
 * found in other implementations of resizeable arrays. One thing to keep in mind is that
 * it is not allowed to add null references.
 * <p>
...
public class ArrayBackedIndexCollection {
	 ...
	 * @return the index of the first occurrence of the value if found, -1 if the element is not found
	 */
