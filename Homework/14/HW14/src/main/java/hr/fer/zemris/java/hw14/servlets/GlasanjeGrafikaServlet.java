...
public class GlasanjeGrafikaServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		JFreeChart chart = createChart(createDataset(data), "Voting poll");
	 ...
	 * 
	 * @param data
	 *            a list of all the options and their received votes
	 * @return the new dataset
	 */
	private PieDataset createDataset(List<PollOptions> data) {
